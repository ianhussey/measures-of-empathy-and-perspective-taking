...
data_reshaped <- data_processed_after_exclusions |>
  select(unique_id, timepoint, SITES, IRI_FS, IRI_EC, IRI_PT, IRI_PD, IRI_total, EQ_total, PET_total, EYES_total, PTTA_total) |>
  pivot_wider(id_cols = unique_id,
              names_from = timepoint,
              values_from = c(SITES, IRI_FS, IRI_EC, IRI_PT, IRI_PD, IRI_total, EQ_total, PET_total, EYES_total, PTTA_total))
...
p_trt_scales + 
  p_trt_subscales + 
  plot_layout(ncol = 1, heights = c(1, .65))
...
data_reshaped_plotting <- data_processed_after_exclusions |>
  select(unique_id, timepoint, SITES, IRI_FS, IRI_EC, IRI_PT, IRI_PD, IRI_total, EQ_total, PET_total, EYES_total, PTTA_total) |>
  pivot_longer(cols = c(SITES, IRI_FS, IRI_EC, IRI_PT, IRI_PD, IRI_total, EQ_total, PET_total, EYES_total, PTTA_total),
               names_to = "scale",
               values_to = "score")
